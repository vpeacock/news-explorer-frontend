...
export const emailInputSignup = document.querySelector('#email-signup');
export const passwordInputSignup = document.querySelector('#login-password-signup');
export const nameCheckSignup = document.querySelector('#name-check-signup');
export const emailLoginAuth = document.querySelector('#email-login-auth');
export const loginPasswordAuth = document.querySelector('#login-password-auth');
...
export const textLogoutButton = document.querySelector('.button__name');
...
export const blockKeywords = document.querySelector('.user-block__keywords');
export const keywords = document.querySelector('.user-block__keyword');
export const articlesCount = document.querySelector('.title__count');

// **Search Container**
export const searchTitle = document.querySelector('.search__title');
export const searchSubtitle  = document.querySelector('.search__subtitle');

// **Popup**
export  const popupSignupDE = document.querySelector('.popup-signup');
